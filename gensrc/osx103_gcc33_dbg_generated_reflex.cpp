...
static PyObject* std__type_info_____del__ (PyObject*, PyObject* args) {
  PyObject* self = PyTuple_GetItem(args, 0);
  args = PyTuple_GetSlice(args, 1, 999999);  
  {
    if (PyTuple_Size(args) == 0) {
      try {
        delete ((std::type_info*)((ProxyObject*)self)->__the_instance__);
        Py_INCREF(Py_None);
        return Py_None;
      } catch (...) {
        PyErr_SetString(PyExc_Exception, "C++ exception");
  ...
  PyObject_Print(args, stdout, 0);
  PyErr_SetString(PyExc_TypeError, "No method with matching arguments found for call to '__del__'");
  return 0;
}
...
static PyMethodDef MethodsStructFor_type_info[] = {
  ...
  {"__del__", std__type_info_____del__, METH_VARARGS, ""},
  { NULL } /* Sentinel */
};
...
static PyObject* seal__reflex__Member_____del__ (PyObject*, PyObject* args) {
  PyObject* self = PyTuple_GetItem(args, 0);
  args = PyTuple_GetSlice(args, 1, 999999);  
  {
    if (PyTuple_Size(args) == 0) {
      try {
        delete ((seal::reflex::Member*)((ProxyObject*)self)->__the_instance__);
        Py_INCREF(Py_None);
        return Py_None;
      } catch (...) {
        PyErr_SetString(PyExc_Exception, "C++ exception");
...
static PyObject* seal__reflex__Member___isDestructor (PyObject*, PyObject* args) {
  PyObject* self = PyTuple_GetItem(args, 0);
  args = PyTuple_GetSlice(args, 1, 999999);  
  {
    if (PyTuple_Size(args) == 0) {
      try {
        bool bool_result = (bool)((seal::reflex::Member*)((ProxyObject*)self)->__the_instance__)->isDestructor();
        return PyInt_FromLong(bool_result); 
      } catch (...) {
        PyErr_SetString(PyExc_Exception, "C++ exception");
        return 0;
  ...
  PyObject_Print(args, stdout, 0);
  PyErr_SetString(PyExc_TypeError, "No method with matching arguments found for call to 'isDestructor'");
  return 0;
}
...
static PyMethodDef MethodsStructFor_Member[] = {
  ...
  {"__del__", seal__reflex__Member_____del__, METH_VARARGS, ""},
  ...
  {"isDestructor", seal__reflex__Member___isDestructor, METH_VARARGS, ""},
...
static PyObject* __Field_____del__ (PyObject*, PyObject* args) {
  PyObject* self = PyTuple_GetItem(args, 0);
  args = PyTuple_GetSlice(args, 1, 999999);  
  {
    if (PyTuple_Size(args) == 0) {
      try {
        delete ((::Field*)((ProxyObject*)self)->__the_instance__);
        Py_INCREF(Py_None);
        return Py_None;
      } catch (...) {
        PyErr_SetString(PyExc_Exception, "C++ exception");
...
static PyMethodDef MethodsStructFor_Field[] = {
  {"__del__", __Field_____del__, METH_VARARGS, ""},
...
static PyObject* __DEL_____del__ (PyObject*, PyObject* args) {
  PyObject* self = PyTuple_GetItem(args, 0);
  args = PyTuple_GetSlice(args, 1, 999999);  
  {
    if (PyTuple_Size(args) == 0) {
      try {
        delete ((::DEL*)((ProxyObject*)self)->__the_instance__);
        Py_INCREF(Py_None);
        return Py_None;
      } catch (...) {
        PyErr_SetString(PyExc_Exception, "C++ exception");
...
static PyObject* __DEL_____call__ (PyObject*, PyObject* args) {
  PyObject* self = PyTuple_GetItem(args, 0);
  args = PyTuple_GetSlice(args, 1, 999999);
  return ((::DEL*)((ProxyObject*)self)->__the_instance__)->__call__(args);
}


static PyObject* __DEL_____init__ (PyObject*, PyObject* args) {
  PyObject* self = PyTuple_GetItem(args, 0);
  args = PyTuple_GetSlice(args, 1, 999999);  
  {
    seal::reflex::Member* Member_0 = 0;
    if (PyArg_ParseTuple(args, "O&", CommonExtractor, &Member_0)) {
      try {
        ((ProxyObject*)self)->__the_instance__ = new ::DEL(*Member_0);
        Py_INCREF(Py_None);
        return Py_None;
      } catch (...) {
        PyErr_SetString(PyExc_Exception, "C++ exception");
...
static PyObject* __DEL_____get__ (PyObject*, PyObject* args) {
   // "Funny" method: need self in 2 places
  PyObject* self = PyTuple_GetItem(args, 0);
  return ((::DEL*)((ProxyObject*)self)->__the_instance__)->__get__(args);
}


static PyMethodDef MethodsStructFor_DEL[] = {
  {"__del__", __DEL_____del__, METH_VARARGS, ""},
  {"__call__", __DEL_____call__, METH_VARARGS, ""},
  {"__init__", __DEL_____init__, METH_VARARGS, ""},
  {"__get__", __DEL_____get__, METH_VARARGS, ""},
  { NULL } /* Sentinel */
};


static PyMethodDef StaticMethodsStructFor_DEL[] = {
...
static PyObject* seal__reflex__Scope_____del__ (PyObject*, PyObject* args) {
  PyObject* self = PyTuple_GetItem(args, 0);
  args = PyTuple_GetSlice(args, 1, 999999);  
  {
    if (PyTuple_Size(args) == 0) {
      try {
        delete ((seal::reflex::Scope*)((ProxyObject*)self)->__the_instance__);
        Py_INCREF(Py_None);
        return Py_None;
      } catch (...) {
        PyErr_SetString(PyExc_Exception, "C++ exception");
...
static PyMethodDef MethodsStructFor_Scope[] = {
  ...
  {"__del__", seal__reflex__Scope_____del__, METH_VARARGS, ""},
...
static PyObject* seal__reflex__Type_____del__ (PyObject*, PyObject* args) {
  PyObject* self = PyTuple_GetItem(args, 0);
  args = PyTuple_GetSlice(args, 1, 999999);  
  {
    if (PyTuple_Size(args) == 0) {
      try {
        delete ((seal::reflex::Type*)((ProxyObject*)self)->__the_instance__);
        Py_INCREF(Py_None);
        return Py_None;
      } catch (...) {
        PyErr_SetString(PyExc_Exception, "C++ exception");
...
static PyMethodDef MethodsStructFor_Type[] = {
  ...
  {"__del__", seal__reflex__Type_____del__, METH_VARARGS, ""},
...
static PyObject* seal__reflex__Base_____del__ (PyObject*, PyObject* args) {
  PyObject* self = PyTuple_GetItem(args, 0);
  args = PyTuple_GetSlice(args, 1, 999999);  
  {
    if (PyTuple_Size(args) == 0) {
      try {
        delete ((seal::reflex::Base*)((ProxyObject*)self)->__the_instance__);
        Py_INCREF(Py_None);
        return Py_None;
      } catch (...) {
        PyErr_SetString(PyExc_Exception, "C++ exception");
...
static PyMethodDef MethodsStructFor_Base[] = {
  {"__del__", seal__reflex__Base_____del__, METH_VARARGS, ""},
...
static PyObject* __GenericFunction_____del__ (PyObject*, PyObject* args) {
  PyObject* self = PyTuple_GetItem(args, 0);
  args = PyTuple_GetSlice(args, 1, 999999);  
  {
    if (PyTuple_Size(args) == 0) {
      try {
        delete ((::GenericFunction*)((ProxyObject*)self)->__the_instance__);
        Py_INCREF(Py_None);
        return Py_None;
      } catch (...) {
        PyErr_SetString(PyExc_Exception, "C++ exception");
...
static PyMethodDef MethodsStructFor_GenericFunction[] = {
  {"__del__", __GenericFunction_____del__, METH_VARARGS, ""},
...
static PyObject* seal__reflex__TypeTemplate_____del__ (PyObject*, PyObject* args) {
  PyObject* self = PyTuple_GetItem(args, 0);
  args = PyTuple_GetSlice(args, 1, 999999);  
  {
    if (PyTuple_Size(args) == 0) {
      try {
        delete ((seal::reflex::TypeTemplate*)((ProxyObject*)self)->__the_instance__);
        Py_INCREF(Py_None);
        return Py_None;
      } catch (...) {
        PyErr_SetString(PyExc_Exception, "C++ exception");
...
static PyMethodDef MethodsStructFor_TypeTemplate[] = {
  ...
  {"__del__", seal__reflex__TypeTemplate_____del__, METH_VARARGS, ""},
...
static PyObject* seal__reflex__MemberTemplate_____del__ (PyObject*, PyObject* args) {
  PyObject* self = PyTuple_GetItem(args, 0);
  args = PyTuple_GetSlice(args, 1, 999999);  
  {
    if (PyTuple_Size(args) == 0) {
      try {
        delete ((seal::reflex::MemberTemplate*)((ProxyObject*)self)->__the_instance__);
        Py_INCREF(Py_None);
        return Py_None;
      } catch (...) {
        PyErr_SetString(PyExc_Exception, "C++ exception");
...
static PyMethodDef MethodsStructFor_MemberTemplate[] = {
  ...
  {"__del__", seal__reflex__MemberTemplate_____del__, METH_VARARGS, ""},
...
static PyMethodDef module_methods_For_reflex[] = {
  {"take_ownership", take_ownership, METH_O, "Make __del__ delete the C++ object held by the proxy."},
  {"funkize", funkize, METH_O, "funkizes a tuple"},
  {"does_proxy_own", does_proxy_own, METH_O, "Shows whether __del__ will delete the C++ object held by the proxy."},
  {"cobjectid", cobjectid, METH_O, "PyCObject_AsVoidPtr ... as Python int"},
  {"loadDictApple", loadDictApple, METH_O, "wrapped dlopen for tmp OS X hack"},
  ...
  {"drop_ownership", drop_ownership, METH_O, "Make __del__ NOT delete the C++ object held by the proxy."},
  {NULL} /* Sentinel */
};
...
initreflex(void) {
  ...
  docstring = PyString_FromString("None");
  PyDict_SetItemString(class_dict, "__doc__", docstring); 
  class_name = PyString_FromString("DEL");
  ClassObject_For_DEL =
  PyObject_CallFunctionObjArgs((PyObject*)&PyType_Type, 
                               class_name, bases, class_dict, NULL); 
  PyObject_SetAttrString(ClassObject_For_DEL, "__typeinfo__", PyCObject_FromVoidPtr((void*)&typeid(::DEL), 0));

  //  Register class in module
  PyDict_SetItemString(module_dict, "DEL", ClassObject_For_DEL);
  //  Register methods in class
  for (PyMethodDef* method = MethodsStructFor_DEL; method->ml_name != NULL; method++) {
    PyObject* function = PyCFunction_New(method, NULL);
    PyObject* pymethod = PyMethod_New(function, NULL, ClassObject_For_DEL);
    PyObject_SetAttrString(ClassObject_For_DEL, method->ml_name, pymethod);
    Py_DECREF(function);
    Py_DECREF(pymethod);
  }
  // Register static methods in class
  for (PyMethodDef* method = StaticMethodsStructFor_DEL; method->ml_name != NULL; method++) {
    PyObject* function = PyCFunction_New(method, NULL);
    PyObject_SetAttrString(ClassObject_For_DEL, method->ml_name, function);
    Py_DECREF(function);
  }
  ...
  PyDict_SetItemString(typeinfo_to_class_dict, typeid(::DEL).name(), ClassObject_For_DEL);
